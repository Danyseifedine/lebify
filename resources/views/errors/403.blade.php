...
<head>
    ...
    <meta name="description" content="403 Access Forbidden - You don't have permission to access this page or resource.">
    <meta name="robots" content="noindex, nofollow">
    <meta name="author" content="Dany Seifeddine">
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>403 Access Forbidden | {{ env('APP_NAME') }}</title>

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="403 Access Forbidden | {{ env('APP_NAME') }}">
    <meta property="og:description" content="Sorry, you don't have permission to access this page or resource.">
    <meta property="og:image" content="{{ asset('vendor/img/errors/error-page.svg') }}">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url()->current() }}">
    <meta property="twitter:title" content="403 Access Forbidden | {{ env('APP_NAME') }}">
    <meta property="twitter:description" content="Sorry, you don't have permission to access this page or resource.">
            ...
            <div class="d-flex flex-column flex-center text-center p-6">
                <div class="card card-error w-lg-850px py-8">
                    <div class="card-body py-12 py-lg-20">
                        <h1 class="fw-bolder fs-2hx text-logo mb-4">403 - Access Forbidden</h1>
                        ...
                        <div class="fw-semibold fs-6 text-gray-500 mb-5">
                            ...
                            <a href="mailto:lebify@gmail.com" class="text-logo">lebify@gmail.com</a> for
                            assistance.
                        </div>
                        <div class="mb-0">
